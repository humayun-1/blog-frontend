    ...
    return (
        <div className='bg-[#4c4c4c]'>
            <FlexCol className={'container py-[1rem] gap-3 text-white'}>
                ...
                <p className='text-xs'>Copyright © 2023 Kazakhstan Review. The Kazakhstan Review is not responsible for the content of external sites. Read about our approach to external linking.</p>
            </FlexCol>
        </div>
    )
}
